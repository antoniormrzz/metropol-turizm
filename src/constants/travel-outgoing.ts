export default [
  ...
  // 2 FİZEMLİ FAS FURU
  {
    ...
    days: [
      ...
      },
      {
        ...
        subTitle: "MARAKEŞ",
        content:
          "Otelimizde alacağımız kahvaltı sonrası Essaouira turumuzu gerçekleştirmek üzere yola çıkıyoruz. Turumuz için Atlas Okyanusu kıyısında yer alan eski Portekiz şehri Essaouira şehrine gidiyoruz. UNESCO Dünya Mirasları Listesi’nde yer alan, bir balıkçı limanı ve sanat ve kültürün iç içe geçtiği bu sahil kentinde şehrin kalesini ve balıkçı limanını gezdikten sonra eski Roma kentlerinden esinlenerek inşa edilmiş Medina’yı geziyoruz. Öğle yemeğimizi yerel bir restoranda aldıktan sonra tekrar Marakeş’de ki otelimize transfer oluyoruz. Akşam yemeği otelimizde.",
      ...
      {
        title: "8.Gün",
        subTitle: "MARAKEŞ- İSTANBUL",
        content:
          "Otelimizde alacağımız sabah kahvaltımızın ardından havalimanına transfer. Bilet, bagaj ve pasaport işlemlerinin ardından THY’nin TK620 sefer sayılı uçağı ile 15:55’de İstanbul’a hareket ve turumuzun sonu.",
      },
    ],
    includes: [
...

  {
    ...
    days: [
      {
        title: "1.Gün",
        subTitle: "İSTANBUL – CAPE TOWN",
        content:
          "İstanbul Havalimanı Dış Hatlar Gidiş Terminali’nde saat 10:55’de buluşma. Bilet ve bagaj işlemlerinin ardından Türk Hava Yolları‘nın TK44 tarifeli seferi ile saat 01:55’de Cape Town’a uçuş. Yerel saat ile 11:20’de varışın ardından bizleri bekleyen özel aracımız ile havalimanından ayrılıyor ve panoramik olarak gerçekleştireceğimiz Cape Town şehir turumuza başlıyoruz. Parlamento Binası, Company Gardens, Long Street, Ümit Kalesi, Reibeck Heykeli ve Adderly Caddesi şehir turumuzda göreceğimiz yerler arasındadır. Tur sonrası konaklama yapacağımız otelimize transfer ve serbest zaman.",
        breakfast: "---",
        lunch: "Ekstra olarak alınacaktır.",
        dinner: " Ekstra olarak alınacaktır.",
      ...
      },
      {
        ...
        subTitle: "CAPE TOWN",
        content:
          "Kahvaltının ardından öğle yemekli Ümit Burnu turumuzu gerçekleştirmek üzere otelimizden hareket ediyoruz. Turumuza eski bir balıkçı kasabası olan Hout Bay ile başlıyoruz. Burada vereceğimiz serbest zamanda rıhtımda yer alan hediyelik eşya mağazalarında vaktinizi geçirebilirsiniz. Sonrasında, fotoğraf severler için inanılmaz bir manzara sunan Chapman tepesini ve Ümit Burnu Milli Parkını ziyaret ediyoruz. Bu milli park, birçok endemik bitki ve hayvan türüne de ev sahipliği yapar. Sadece Güney Afrika'ya özgü karakteristik bitki örtüsü “fynbos”un yanında pek çok geyik ve kuş türü, Cape dağ zebrası ve babunu da yine burada görebilirsiniz. Yine deniz fenerine kadar yürüyebilir (veya ekstra olarak feniküleri kullanabilir) ve Cape Burnu’nda Atlantik ve Hint Okyanuslarının buluşmasına tanıklık edebilirsiniz. Sonrasında False körfezinin muhteşem manzarası eşliğinde öğle yemeğimizi alıyoruz. Güney Afrika’nın ünlü penguenlerini görmek üzere Boulders sahiline gidiyor ardından Simonstown’daki ünlü deniz üssünü ziyaret ediyoruz. Turumuzun ardından Cape Town’a dönüş ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: " Ümit Burnu turunda ücrete dahil olarak alınacaktır.",
        dinner: " Ekstra olarak alınacaktır.",
        currency: "Güney Afrika – Rand",
      },
      {
        ...
        subTitle: "CAPE TOWN ",
        content:
          "Kahvaltının ardından öğle yemekli Masa Dağı & Stellenbosh Çiftliği turumuzu gerçekleştireceğiz. Öncelikle yörenin ünlü içeceklerini tadacağımız turumuza çıkıyoruz. 45 dakikalık yolculuğumuzun ardından geleceğimiz bu çiftlikte; önce mahzenleri geziyor ardından tadım yapıyoruz. Daha sonra 1679’ da kurulmuş olan Stellenbosh kasabasına geçiyor ve şarapları, meşe ağaçları ve üniversitesi ile ünlü bu kasabada panoramik şehir turu yapıyoruz. Ardından Spier Çiftliğinde; Eagle Encounter’da Güney Afrika’nın vahşi kuşlarını görüyoruz. Restoranda alınacak öğle yemeği sonrasında Masa Dağı’nın 1087 m yükseklikteki tepesine çıkıp bu doyumsuz manzarayı izliyoruz. Tur sonrası otelimize dönüş ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch:
          "Masa Dağı & Stellenbosh Çiftliği turunda ücrete dahil olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Güney Afrika – Rand",
      },
      {
    ...
    warning_for_teenagers: [
      "• 1 Haziran 2015 tarihinden itibaren Güney Afrika Cumhuriyeti’ne seyahat edecek olan 18 yaş altı çocuklar için, Güney Afrika Cumhuriyeti makamları ülkeye girişte “doğum sertifikası” (unabridged birth certificate) talep edecektir. Türkiye’de doğum sertifikası olmadığı için, Nüfus Müdürlükleri’nden alınan Nüfus Kayıt Örneği yeminli tercümanda tercüme ettirildikten sonra doğum sertifikası yerine geçecektir. Güney Afrika’da mukim Türk vatandaşları da Büyükelçiliğimizden Nüfus Kayıt Örneğini temin edebilirler.",
      "• Güney Afrika - 18 Yaş Altı Çocuklar için Doğum Belgesi Zorunluluğu Yeni Göçmen Düzenlemesi",
      "1- Ebeveynleri ile beraber seyahat eden çocuklar için gerekenler:",
      "Ebeveynler beraber seyahat ettikleri çocuk/çocukların ebeveynleri olduklarını ispatlayan doğum belgelerini ibraz etmekle yükümlüdürler. Evlat edinilmiş çocuklar için ebeveynler evlat edinmiş olduklarını ispatlayan evlat edinme sertifikasını ibraz etmek mecburiyetindedirler.",
      "Açıklayıcı not: Bu uygulama hem Güney Afrika vatandaşlarına hem diğer yabancılara gidişte ve varışta uygulanacaktır. Doğum sertifikası vermeyen ülkelerden giriş/çıkış yapan yolcular için yetkili bir makamdan alınacak doğum sertifikası yerine geçecek bir belge ibraz edilmelidir. İbraz edilen bütün dokümanlar orijinal veya noter veya dengi bir makamdan onaylı kopyası olmalıdır.",
      "2- Ebeveynlerinden yalnızca biri ile beraber seyahat eden çocuklar için gerekenler: ",
      "Ebeveynler beraber seyahat ettikleri çocuk/çocukların ebeveynleri olduklarını ispatlayan doğum belgelerini ibraz etmekle yükümlüdürler. Doğum belgesinde kayıtlı seyahat etmeyen diğer ebeveynin, çocuğun diğer ebeveyni ile beraber Güney Afrika’ya giriş ve/veya çıkış yapabileceğine dair yeminli muvafakatnamesi ibraz edilmelidir. Tüm ebeveynlik hak ve sorumluluklarını veya yasal velayetini devreden mahkeme emri ibraz edilmeli veya Doğum belgesinde kayıtlı ebeveynlerden birinin ölümü durumunda, vefat eden ebeveynin ölüm belgesi ibraz edilmelidir. Seyahat etmeyen ebeveynin muvafakatname vermediği durumlarda, yasal olarak boşanmış çiftlerin de mahkeme emri ibraz etmeleri gerekmektedir. Her iki ebeveynin de vefat ettiği ve çocuğun bir akrabası veya anne/babasının başka bir yetişkin yakını ile beraber seyahat ettiği durumlarda, çocuğa refakat eden kişi çocuk ile beraber Güney Afrika Cumhuriyeti’ne girdiğini veya Güney Afrika Cumhuriyeti’nden ayrıldığını Genel Müdürlüğe onaylatmalıdır.",
      "Açıklayıcı not: Muvafakatname tarihi seyahat tarihinden en fazla 3 ay öncesi olabilir.",
      "3- Biyolojik ebeveyni olmayan yetişkinlerle seyahat eden çocuklar için gerekenler: ",
      "Yetişkin çocuğun doğum belgesinin bir kopyasını ibraz etmelidir. Çocuğun ebeveynlerinin veya yasal velisinin ilgili kişinin çocuk ile seyahat edebileceğine dair muvafakatnamesi ibraz edilmelidir. Çocuğun ebeveynlerinin veya yasal velisinin kimlik doküman ya da pasaport kopyaları ile Çocuğun ebeveynlerinin veya yasal velisinin iletişim bilgileri ibraz edilmelidir. Her iki ebeveynin de vefat ettiği ve çocuğun bir akrabası veya anne/babasının başka bir yetişkin yakını ile beraber seyahat ettiği durumlarda, çocuğa refakat eden kişi çocuk ile beraber Güney Afrika Cumhuriyeti’ne girdiğini veya Güney Afrika Cumhuriyeti’nden ayrıldığını Sınır Polisine onaylatmalıdır.",
      "4- Herhangi bir yetişkin ile beraber seyahat etmeyen çocuklar için gerekenler: ",
      "18 yaşından küçük kişilerin Güney Afrika’ya giriş ve çıkışlarında seyahat edebilmesi için anne ve babanın veya tek olarak ya da yasal varisinin bir mektup veya açıklama sunması gerekmektedir. Eğer anne ve babanın biri bu belgeyi sunuyorsa, kendisinin tamamen vasilik hakkına sahip olduğunu gösteren mahkeme kararını da sunması gerekmektedir. Güney Afrika’da çocuğun kalacağı yerin ve çocuğu karşılayacak yetişkinin ikamet adresini ve iletişim bilgilerini içeren bir mektup ibraz edilmelidir. Güney Afrika’da çocuğu alacak kişinin kimlik kartı veya geçerli pasaport ve vize veya kalıcı oturum izni kopyası ibraz edilmelidir. Çocuğun ebeveynlerinin ya da yasal velisinin iletişim bilgileri ibraz edilmelidir.",
      "5- 2005 yılı Çocuk Yasasında tanımlanan özel bakım altında olan çocuklar için gerekenler: ",
      "Güney Afrika Cumhuriyeti’nden çıkış yapmadan önce, Çocuk Yasası’nın 169. Bölümünde öngörülen şekilde çocuğun ikamet ettiği Sosyal Hizmetler İl Müdürlüğü’nden alınan izin kâğıdının onaylı bir kopyası ibraz edilmelidir.",

      "NOTLAR:",
      "• 18 yaş altındaki bireyler çocuk olarak tanımlanmıştır.",
      "• T.C. Vatandaşları için Nüfus Müdürlükleri’nden alınan Nüfus Kayıt Örneği yeminli tercümanda tercüme ettirildikten sonra doğum sertifikası yerine geçecektir. Güney Afrika’da mukim Türk vatandaşları da Büyükelçiliğimizden Nüfus Kayıt Örneğini temin edebilirler.    ***Alınacak doğum belgesi üzerinde mühür(APOSTILLE) olması gerekiyor. Bu mühür Kaymakamlık veya Valilik’lerde bulunuyor. (Sadece noterden tasdik ve İngilizce tercüme yeterli olmayacaktır, devlet mührü gerekmektedir!",
      "• Resmi evraklardan yanınızda en az 5 suret bulunması gerekmektedir.",
      "• Bahsedilen dökümanların İngilizce lisanı haricinde olanların, yeminli tercüman tarafından İngilizceye çevrilmiş olması gerekmektedir.",
      "• Daha detaylı resmi bilgiye aşağıda bulunan Güney Afrika hükümetinin sayfasından ulaşabilirsiniz.",
      "http://www.dha.gov.za/index.php/statements-speeches/475-home-affairs-encourages-parents-to-get-unabridged-birth-certificates-for-children",
    ],
    general_infos: [
      "Genel şartlar ‘Tur Broşürü’ nün ve ‘Tur Kayıt Sözleşmesi’nin ayrılmaz bir parçasıdır, bağımsız düşünülemez.",
...

  {
    ...
    days: [
      ...
      {
        title: "2.Gün",
        subTitle: "KOLOMBO – NEGOMBO ",
        content:
          "Yerel saat ile 15:00’da varışın ardından bizleri bekleyen özel aracımız ile havalimanından ayrılıyor ve konaklama yapacağımız balıkçı kasabası olan Negombo’ya hareket ediyoruz. Varışımıza istinaden akşam yemeğimizi almak ve dinlenmek için otelimize transfer oluyoruz.",
        breakfast: "---",
        lunch: "---",
        dinner: "Otelde ücrete dahil olarak alınacaktır.",
      ...
      {
        title: "4.Gün",
        subTitle: "DAMBULLA – POLONNARUWA – SIGIRAYA – DAMBULLA  ",
        content:
      ...
      {
        title: "5.Gün",
        subTitle: "DAMBULLA – KANDY – NUWARA ELIYA",
        content:
      ...
      },
      {
        ...
        content:
          "Sabah kahvaltısı sonrası başkent Kolombo’ya hareket ediyoruz. Varışımızın ardından öğle yemeğimizi yerel bir restoranda aldıktan sonra panoramik olarak gerçekleştireceğimiz Kolombo şehir turumuza başlıyoruz. Şehir turumuzun ardından havalimanına transfer. Bilet, bagaj ve pasaport işlemlerinin ardından Türk Hava Yolları’nın TK731 seferi ile saat 20:20'de İstanbul'a hareket.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Ücrete dahil olarak alınacaktır.",
        dinner: "---",
        currency: "Güney Afrika – Rand",
    ...
    general_infos: [
      ...
      "• Tur – Alan – Tur Lideri - Otel bilgilendirmeleri tur hareketinden 48 saat önce operasyon departmanı tarafından mail yolu ile gönderilecektir.",
      "• Pasaport resmi bir belge niteliğinde olup herhangi bir şekilde zedelenmiş, kirlenmiş, özellikle dikişte veya sayfalarında yırtık olması gibi sebeplerden dolayı pasaport polisi sizi ülkeye sokmama yetkisine sahiptir. Böyle bir durumda sorumluluk yolcuya aittir. ",
      "• Vize başvurusu için tur bitim tarihinden itibaren en az 6 ay geçerli pasaport ve konsolosluk tarafından istenilen evraklar gerekmektedir. Bu turda Türk vatandaşları için vize gerekmektedir. Tüm TC pasaport hamilleri vizeye tabi olup, 30 güne kadar turistik amaçlı seyahatlerinde vizelerini www.eta.gov.lk internet adresinden veya ülkeye girişte sınır kapılarında alabilmektedirler. Vize alınmış olması ülkeye giriş yapılabileceği anlamına gelmez. Pasaport polisi yolcuyu ülkeye sokmama yetkisine sahiptir. Böyle bir durumda sorumluluk yolcuya aittir.",
      ,
    ],
  },
  ...
  // 7 UKRAYNA TURU
  {
    ...
    days: [
      {
        title: "1.Gün",
        subTitle: "İSTANBUL – LVIV",
        content:
          "İstanbul Havalimanı Dış Hatlar Terminali’nde saat 04:45'de buluşma. Bilet, pasaport ve bagaj işlemlerinin ardından Türk Hava Yolları’nın TK441 tarifeli seferi ile saat 07:45'de Lviv’e hareket. Yerel saat ile saat 09:45'de Lviv'e varış. Varışımızın ardından panoramik olarak gerçekleştireceğimiz Lviv şehir turumuza başlıyoruz. Turumuz sırasında Lviv kurucusunun heykeli, UNESCO tarafından koruma altına alınan şehrin trafiğe kapalı alanı, opera binası, Pazar meydanındaki tarihi her biri farklı hikayeye sahip binaları ve tarihi kiliseleri de gördükten sonra otelimize transferimizi gerçekleştiriyoruz. Odalara yerleşmenin ardından serbest zaman. Rehberimizin belirleyeceği saatte otelimizden hareket edip Eczacılık müzesi & Çikolata Fabrikası Satış Mağazası & Ünlü Ermeni Kilisesi  & Arsenal turumuzu gerçekleştiriyoruz. Turumuzun ardından otelimize transfer ve serbest zaman. Akşam ise Lviv’in en eğlenceli mekanlarında güne devam edebilirsiniz.",
        breakfast: "---",
        lunch: "Ekstra olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
      ...
      },
      {
        ...
        subTitle: "LVIV",
        content:
          "Sabah kahvaltısının ardından öğle yemekli Şatolar turumuz için otelimizden ayrılıyoruz. Gezimiz sırasında Lviv bölgesinde 16. yüzyıldan kalma tarihi şatolardan en önemli 3 tanesini görme imkanımız olacak. Şato gezilerinin ardından öğle yemeğini yine gezdiğimiz şatonun içindeki batı Ukrayna mutfağı ile ünlü restoranımızda alıyoruz. Yemekten sonra Lviv’e dönüş ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Şatolar turunda fiyata dahil olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Ukrayna – Grivna",
      },
      {
        title: "3.Gün",
        subTitle: "LVIV – RİVNE – KIEV",
        content:
          "Sabah kahvaltısının ardından otelden çıkış işlemlerimizi gerçekleştirip Kiev’e hareket ediyoruz. Yol üzerinde öğle yemeği için Rivne şehrinde vereceğimiz mola sonrası öğleden sonra Kiev'e varış ile birlikte panoramik olarak gerçekleştireceğimiz şehir turumuza başlıyoruz. Şehir turumuz Vladimirskaya Caddesinde bulunan Merkez Opera ve Bale Binası ile başlıyor. Opera ve Bale binasının ardından ünlü Altın Kapı’yı görerek Aya Sofya Meydanı’nda kısa bir mola verdikten sonra Dostluk Heykeli’nin yer aldığı Dostluk Tepesi’ni ziyaret edip Shevchenko Bölgesi’nde yer alan ve Kiev’in en merkezi ve işlek caddesi olan ve Europeiskaya ile Bessarabskaya Meydanlarını birbirine bağlayan eşsiz bir konuma sahip ünlü Kreschatik caddesine geçiyoruz. Bu gezilerimizin ardından otobüsümüzle Kiev’in en eski semtlerinden biri olan Padol’u ziyaret edip burada Başbakanlık, Parlamento Binası, Mihaylovski Kilisesi, Knyagine Olga Heykeli’ni panoramik olarak gördükten sonra şehir turumuzu tamamlıyoruz. Tur sonrası konaklama yapacağımız otelimize geçiyoruz.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Ekstra olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Ukrayna – Grivna",
      ...
      },
      {
        ...
        content:
          "Sabah kahvaltısının ardından Odessa’ya doğru hareket ediyoruz. Varışımıza istinaden panoramik olarak gerçekleştireceğimiz Odessa şehir turumuza başlıyoruz. Bu turda, Odessa Opera Binası, Çariçe 2. Katerina Anıtı, dünyaca ünlü Potemkin Merdivenlerinin yansıra, eşsiz mimari örneklerini göreceğiz. Turumuzun ardından otelimize transfer ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Ekstra olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Ukrayna – Grivna",
    ...
    includes: [
      ...
      "Havalimanı vergileri",
      "Lviv’de 2 gece – Kiev’de 3 gece – Odessa’da 2 gece olmak üzere toplam 7 gece oda + kahvaltı konaklama",
      "Odessa, Kiev ve Lviv’de yapılacak panoramik şehir turları",
      "Havalimanı – otel – havalimanı transferleri",
      "Tüm şehirlerarası transferler",
      "Otel vergileri",
  ...
  // 8 ÜRDÜN TURU
  {
    ...
    days: [
      {
        title: "1.Gün",
        subTitle: "İSTANBUL – AKABE",
        content:
          "İstanbul Yeni Havalimanı Dış Hatlar Gidiş Terminalinde saat 19:00’da buluşma. Bagaj, pasaport ve biniş işlemlerinden sonra, saat 22:00’de THY’nin TK818 sefer sayılı uçağı ile Akabe’ye hareket.",
      },
      {
        title: "2.Gün",
        subTitle: "AKABE – BEDEVİ KAMPI",
        content:
          "Yerel saat ile 00:45’de varışımızın ardından havalimanında bizleri bekleyen aracımız ile otelimize transfer. Kısa bir dinlenmenin ardından alacağımız kahvaltı sonrası panoramik olarak gerçekleştireceğimiz Akabe şehir turumuza başlıyoruz. Turumuzda 16. yüzyılda Memlükler Dönemi'nde inşa edilen Akabe Kalesi, 1916 Arap İsyanının lideri ve şimdiki kralın büyük dedesi olan Sherif al-Hussein bin Ali Camisi ve Ortaçağ Dönemi'nde kurulan İslami şehir Ayla göreceğimiz yerler arasındadır. Turumuzun ardından yaklaşık 1 saatlik mesafede bulunan ve konaklamamızı yapacağımız Rum Vadisi’nde yer alan Bedevi kampına transferimizi gerçekleştiriyoruz. Öğle yemeğimizi kampın restoranında alıp öğleden sonra yaklaşık 2 saat sürecek olan 4x4 jeep ler ile safari turumuzu gerçekleştiriyoruz. Tur sonrası kampa dönüş ve serbest zaman. Akşam yemeği kampta.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Kampta ücrete dahil olarak alınacaktır.",
        dinner: "Kampta ücrete dahil olarak alınacaktır.",
        currency: "Ürdün – Dinar",
      },
      {
        title: "3.Gün",
        subTitle: "AKABE – PETRA",
        content:
          "Sabah çok erken saatte kalkıp yaklaşık 1 saat sürecek Deve Safari turumuzu gerçekleştiriyoruz. Turumuzda güneşin doğuşunu izleme imkanımız olacak. Turun ardından kahvaltı için kampa dönüyoruz. Kahvaltı sonrası yaklaşık 2 saatlik mesafede bulunan Petra’ya hareket ediyoruz. Varışımıza istinaden yerel bir restoranda öğle yemeğimizi alıp Petra gezimize başlıyoruz. Gezimis esnasında The Siq, El-Hazne Binası, Amfi Tiyatro, Royal Tombs, Colonnadded Street, Qasr el-Bint ve El-Deir Manastırı göreceğimiz yerler arasındadır. Gezi sonrası otelimize transfer ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Yerel restoranda ücrete dahil olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Ürdün – Dinar",
      ...
      {
        title: "4.Gün",
        subTitle: "PETRA – ÖLÜ DENİZ",
        content:
          "Otelimizde alacağımız kahvaltının ardından Ölü Deniz’e doğru yola çıkıyoruz. Yol güzergahımız üzerinde önce deniz seviyesinden 900 metre yukarıda yükselen üçgen platoda, eski şehri oluşturan antik duvarlarla çevrili kalesiyle ünlü Kerak kasabasına uğruyoruz. Daha sonra yaklaşık 1,5 saat uzaklıkta yer alan, Tevrat’a göre Hz. Musa’nın Vaat Edilen Toprakları gördüğü ve öldüğü dağ olan Nebo Dağı’nı görüyoruz. Ardından Kral Yolu üzerinde yer alan ve dünyada 'Mozaikler Şehri' olarak bilinen Medeba’ya varıyoruz. Burada yerel bir restoranda alacağımız öğle yemeği sonrası Medeba gezimizi gerçekleştiriyoruz. Gezimiz sonrası yaklaşık 1 saatlik mesafede bulunan Ölü Deniz’de ki otelimize transfer ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Yerel restoranda ücrete dahil olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Ürdün – Dinar",
      ...
      {
        title: "5.Gün",
        subTitle: "ÖLÜ DENİZ – AMMAN",
        content:
          "Kahvaltının ardından rehberimizin belirleyeceği saate kadar Ölü Deniz’de serbest zaman. Ardından yaklaşık 1 saat mesafede bulunan başkent Amman’a hareket ve varışın ardından otelimize transfer. Öğleden sonra Amman şehir turumuzu gerçekleştiriyoruz. Şehir turumuz esnasında Amman Kalesi, Herkül Tapınağı’nı göreceğiz. Ardından Jordan Archaeological Museum'u ziyaret edeceğiz. Müze ziyaretimiz sonası The Hashemite Plaza’ya devam edecek, Roman Tiyatrosu ve Odeon’u ziyaret edeceğiz. Turumuzun ardından otelimize transfer ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Ekstra olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Ürdün – Dinar",
  ...
  // 9 VİETNAM KAMBOÇYA TURU
  {
    ...
    days: [
      {
        title: "1.Gün",
        subTitle: "İSTANBUL – SAIGON (HO CHI MINH)",
        content:
          "İstanbul Havalimanı Dış Hatlar Gidiş Terminali’nde saat 22:50’de buluşma. Bilet ve bagaj işlemlerinin ardından Türk Hava Yolları‘nın TK162 tarifeli seferi ile saat 01:50’da Ho Chi Minh’e uçuş.",
      },
      {
        title: "2.Gün",
        subTitle: "SAIGON (HO CHI MINH)",
        content:
          "Yerel saat ile 16:55’de varışın ardından bizleri bekleyen özel aracımız ile konaklama yapacağımız otelimize transfer. Akşam yemeğimizi yerel bir restoranda alıyoruz.",
        breakfast: "---",
        lunch: "---",
        dinner: "Otelde fiyata dahil olarak alınacaktır.",
      ...
      },
      {
        ...
        subTitle: "SAIGON (HO CHI MINH)",
        content:
          "Kahvaltının ardından “Öğle yemekli Mekong Deltası” turumuzu gerçekleştireceğiz. Turumuz için suyun üzerinde suyla iç içe yaşayan bir dünyaya, My Tho kasabasına hareket ediyoruz. Varışımızı takiben yerel bir tekne ile birbirini kesen kanal sokaklar arasında gezintiye başlıyoruz. İlk durağımız yöreye özgü el yapımı eşyaların yapılışını, Hindistan cevizinden üretilen şekerlerin imalathanelerini ve rengârenk meyve bahçelerini göreceğimiz Thoi Son Adası. Daha sonra ev yapımı bal çayının tadına bakmak için bir çiftliğe uğruyor ve kanallar arasında devam eden turumuzda yörenin yaşayışı hakkında bilgiler alıyoruz. Ardından Vinh Trang Pagodası’nı ziyaret ediyoruz. Öğle yemeğimizi yerel restoranda alıyoruz. Öğle yemeği sonrası otelimize transfer ve dinlenmek için serbest zaman. Dileyen misafirlerimiz akşam Vespa Scooter turumuza katılabilirler. Bu turumuzda Vietnam sokak lezzetlerini tadacak, Ho Chi Minh’in gece hayatına yakından şahitlik edecek, Vietnam stili coffe shop larda güzel vakit geçireceksiniz. Turun ardından otelimize transfer. (Vespa Scooter Turu Kişi Başı  110$)",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Mekong Deltası turunda ücrete dahil olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Vietnam – Dong",
      },
      {
        title: "4.Gün",
        subTitle: "SAIGON (HO CHI MINH) – SIEM REAP",
        content:
      ...
      {
        title: "5.Gün",
        subTitle: "SIEM REAP – ANGKOR THOM – ANGKOR WAT – SIEM REAP",
        content:
          "Kahvaltının ardından UNESCO Dünya Mirası Listesi’nde yer alan Angkor Thom turumuz başlıyor. İlk durağımız Angkor Thom ve Güney Kapısı. Daha sonra Bayon Tapınağı, Baphuon Tapınağı ve Ta Phrom Tapınağı’nı geziyor ve Cüzamlı Kral ve Fil Teraslarını ve Phnom Ba Kheng Tapınağı’nı ziyaret ettikten sonra öğle yemeğimizi almak üzere otel dönüyoruz. Yemeğimizi aldıktan sonra, öğleden sonra efsanevi insanlık tarihinin en muazzam yapıtlarından biri olan Angkor Wat gezimizi gerçekleştiriyoruz. Tur sonrası otelimize dönüş ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Yerel restoranda fiyata dahil olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Kamboçya – Riel",
      },
      {
        title: "6.Gün",
        subTitle: "SIEM REAP – HANOI",
        content:
          "Kahvaltının ardından Hanoi uçuş saatimize kadar serbest zaman. Serbest zaman sonrası rehberimizin belirleyeceği saatte havaalanına transfer olup, yerel havayolları ile Hanoi’ye uçuyoruz. Varışta otele transfer ve serbest zaman.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: " Ekstra olarak alınacaktır.",
        dinner: "Ekstra olarak alınacaktır.",
        currency: "Vietnam – Dong",
      },
      {
        ...
        subTitle: "HANOI",
        content:
          "Sabah kahvaltısının ardından panoramik olarak gerçekleştireceğimiz Hanoi şehir turumuz için otelimizden hareket ediyoruz. Şehir turumuzda Hoan Kiem Gölü, Ly Thai To Büstü, Ngoc Son Tapınağı, Ho Chi Minh Mozalesi, Vietnam’ın ilk üniversitesi olan Literatür Tapınağı, Ba Dinh Meydanı ve Pillar Pagoda’sı görülecek yerler arasındadır. Öğle yemeğimizi yerel bir restoranda alıyoruz. Turumuzun sonunda tekrar otelimize dönüyoruz. Akşam yemekli Su Kuklası turumuzu gerçekleştirmek için otelimizden hareket ediyoruz. Tur sonrası otelimize transfer.",
        breakfast: "Otelde ücrete dahil olarak alınacaktır.",
        lunch: "Yerel restoranda fiyata dahil olarak alınacaktır.",
        dinner: "Su Kuklası turunda ücrete dahil olarak alınacaktır.",
        currency: "Vietnam – Dong",
      },
      {
        title: "8.Gün",
    ...
    includes: [
      ...
      "Havalimanı vergileri",
      "Saigon (Ho Chi Minh)’da 2 gece – Siem Reap’de 2 gece – Hanoi’de 3 gece olmak üzere toplam 7 gece oda + kahvaltı konaklama",
      "Saigon ve Hanoi’de panoramik şehir turları ve programda belirtilen tüm çevre gezileri",
      "Programda belirtilen 3 adet akşam yemeği",
      "Programda belirtilen 5 adet öğle yemeği",
      "Saigon – Siem Reap arası yerel havayolları ile ekonomi sınıf uçuş,",
      "Siem Reap – Hanoi arası yerel havayolları ile ekonomi sınıf uçuş,",
      "Havalimanı – otel – havalimanı transferleri",
      "Seyahat sağlık sigortası",
      "Yurtdışı çıkış harcı",
      "Türkçe rehberlik hizmetleri",
    ...
    general_infos: [
      ...
      "• Tur – Alan – Tur Lideri - Otel bilgilendirmeleri tur hareketinden 48 saat önce operasyon departmanı tarafından mail yolu ile gönderilecektir.",
      "• Pasaport resmi bir belge niteliğinde olup herhangi bir şekilde zedelenmiş, kirlenmiş, özellikle dikişte veya sayfalarında yırtık olması gibi sebeplerden dolayı pasaport polisi sizi ülkeye sokmama yetkisine sahiptir. Böyle bir durumda sorumluluk yolcuya aittir. ",
      "• Vize başvurusu için tur bitim tarihinden itibaren en az 6 ay geçerli pasaport ve konsolosluk tarafından istenilen evraklar gerekmektedir. Bu tura katılım için Türk pasaportlu yolcular için Vietnam ve Kamboçya vizeleri gerekmektedir. Vize alınmış olması ülkeye giriş yapılabileceği anlamına gelmez. Pasaport polisi yolcuyu ülkeye sokmama yetkisine sahiptir. Böyle bir durumda sorumluluk yolcuya aittir.",
      "Vietnam: Türk Vatandaşlarına vize uygulamaktadır. (Yeşil pasaporta vize uygulamamaktadır) Vietnam vizesi alabilmek için (Çok girişli) C1 Belgesi alınması zorunludur. Bu belgeyi acentemiz size 100 USD karşılığında verecektir. C1 belgesine ilave olarak misafirlerimiz kapıda 55-USD ödeme yaparak vizelerini alacaklardır. Kapıda 2 Adet resim (arka tarafı beyaz, 4x6 cm boyutlarında) gerekmektedir. Kapı vize ücretleri ülke kararı ile değişiklik gösterebilir.",
      "Kamboçya: Türk vatandaşlarına vize uygulamaktadır. (Yeşil pasaporta da vize alınması gerekmektedir) 2 Adet resim (arka tarafı beyaz, 4x6 cm boyutlarında) ile misafirlerimiz kapıda 30 USD ödeme yaparak vizelerini alabileceklerdir. Kapı vize ücretleri ülke kararı ile değişiklik gösterebilir. ",
    ],
  },
];
