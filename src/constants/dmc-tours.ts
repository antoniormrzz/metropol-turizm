export default [
  ...
  },
  {
    ...
    days: [
      {
        title: "Day 1",
        subTitle: "ARRIVAL ISTANBUL DAY + FREE AT LEISURE DAY (-/-/-)",
        text: [
      ...
      {
        title: "Day 2",
        subTitle: "FULL DAY ISTANBUL HISTORICAL TOUR (B/L/D)",
        text: [
      ...
      {
        title: "Day 3",
        subTitle: "GOLDEN HORN & PANAROMIC CITY TOUR (-/L/D)",
        text: [
          ...
          "Then visit Suleymaniye Mosqueis know as great religious object was built by Magnificent Suleyman and also its known as most masterpiece od great architecture Mimar Sinan. Our day ended with Grand Covered Bazaar included various spices, died fruits, basketry, jewelry’s, leather market, Anatolian and ottoman style souvenir shops and Anatolian style scarf shops. Overnight in Istanbul Hotel.",
        ],
      },
      {
        title: "Day 4",
        subTitle: "FULL DAY BOSPHORUS TOUR (B/L/D)",
        text: [
    ...
    days: [
      {
        ...
        text: [
          "Our representative meet with you at Istanbul Airport and transfer to Çanakkale. Overnight in Canakkale Hotel.",
        ],
      },
      {
        title: "Day 2",
        subTitle: "FULL DAY ANZAC TOUR (B/-/-)",
        text: [
  ...
  },
  {
    ...
    days: [
      ...
      {
        title: "Day 2",
        subTitle: "FULL DAY ISTANBUL MAGNIFICENT TOUR (B/L/D)",
        text: [
          "Breakfast served at hotel and day start with Sultanahmet Hippodrome included German Fountain, Egyptian Obelisk, Serpent Column, Walled Obelisk. Sultanahmet known with oldest historical structures from all cultures and religions.",
          "Our day continue with Sultanahmet Mosque is the one of the most magnificent mosque in Istanbul and Hagia Sophia Museum is the oldest and most important structure for the Christian and Muslim religions. Its builded as a church in Byzantium and turned a mosque in Ottoman Time. End of the day visit one of the important and largest Ottoman Palace name as Topkapı Palace including largest famous ottoman gardens, palace houses and Ottoman Imperial Relics section for have an opportunity to see ottoman treasures. Overnight at Istanbul Hotel.",
        ],
      ...
      {
        title: "Day 6",
        subTitle: "CAPPADOCIA > ISTANBUL (B/L/-)",
        text: [
      ...
      {
        title: "Day 7",
        subTitle: "FULL DAY ISTANBUL BOSPHORUS TOUR (B/L/D)",
        text: [
          "Breakfast served at hotel and day begins with Bosphporus Cruise Tour, it’s a special boat trip with a beautiful view of Istanbul and we have the opportunity to see the historical mansions of the Bosphorus, the most beautiful buildings and impressive blue color of Istanbul.",
          "Our day continue with Camlica Hill for photo shooting time on the highest hill of Istanbul and end of the day free shopping time at Spice Bazaar (Egyptian Market) Bazaar is the most colorful bazaar in İstanbul and that colors coming from various spices, died fruits, basketry and jewelry’s. Overnight at Istanbul Hotel.",
        ],
      },
      {
    ...
    days: [
      {
        ...
        subTitle: "ISTANBUL > CANAKKALE (-/L/D)",
        text: [
          "Our representative meet with you at Istanbul Airport and transfer to Çanakkale. After arrived to city, we have the opportunity to see the original Trojan horse used in the Hollywood movie and then visit historical Trojan Horse and Trojan Ancient City. Overnight at Canakkale Hotel.",
        ],
      },
      {
        title: "Day 2",
  ...
  },
  {
    ...
    days: [
      ...
      {
        title: "Day 2",
        subTitle: "FULL DAY CAPPADOCIA TOUR  + DEPARTURE TRANSFER (B/L/-)",
        text: [
          "Optional Tour : Hot Air Baloon Tour",
          "Breakfast served at hotel. Our journey begins with visit Kaymaklı Underground City built as underground country for protecting their city from enemies in late Hittite period and its included near 100 or more tunnels of underground city. City included 8 floors and that floors included wine stores, water cellars, kitchen and supply stores, ventilation chimneys, water wells, church and large bolt stones that close the door from the inside to prevent any danger from outside. We will continue our tour with Red Valley, Pigeon Valley and Cavusin Village. After finished the tour transfer to your hotel or Nevsehir – Kayseri Airport. End of the Service..",
          "Optional Balloon Tour Service Details;",
          "Before breakfast we pick up you from hotel an hour before sunrise for Hot Air Balloon Tour and transport you to the balloon take-off area, where you will have tea or coffee and some snack. The wind determines where you actually go. On occasion a balloon may actually be able to descend into one of the canyons. Once back on the ground we celebrate the flight with soft drinks and Champagne. After receiving your personalized flight certificates, you are transferred back to your hotel and you can continue with your day in Cappadocia. Turn back to hotel for breakfast service. ",
        ],
      },
    ],
  },
  {
    ...
    days: [
      {
        title: "Day 1",
        subTitle: "GOLDEN WAY ANATOILAN TOUR WITH ANTALYA",
        text: [
  ...
  },
  {
    ...
    days: [
      {
        title: "Day 1",
        subTitle: "ARRIVE ISTANBUL > CANAKKALE  (-/L/D)",
        text: [
      ...
      },
      {
        title: "Day 7",
        subTitle:
          "FULL DAY ISTANBUL HISTORICAL TOUR + DEPARTURE TRANSFER (B/L/D)",
        text: [
          "Breakfast served at hotel and day start with Sultanahmet Hippodrome included German Fountain, Egyptian Obelisk, Serpent Column, Walled Obelisk. Sultanahmet known with oldest historical structures from all cultures and religions.",
  ...
  },
  {
    ...
    days: [
      {
        title: "Day 1",
        subTitle: "ARRIVAL TRANSFER + BOSPHORUS CRUISE TOUR DAY (-/-/D)",
        text: [
      ...
      {
        title: "Day 2",
        subTitle: "FULL DAY ISTANBUL MAGNIFICENT TOUR (B/L/-)",
        text: [
          "Breakfast served at hotel and day start with Sultanahmet Hippodrome included German Fountain, Egyptian Obelisk, Serpent Column, Walled Obelisk. Sultanahmet known with oldest historical structures from all cultures and religions.",
          "Our day continue with Sultanahmet Mosque is the one of the most magnificent mosque in Istanbul and Hagia Sophia Museum is the oldest and most important structure for the Christian and Muslim religions. Its builded as a church in Byzantium and turned a mosque in Ottoman Time. End of the day visit one of the important and largest Ottoman Palace name as Topkapı Palace including largest famous ottoman gardens, palace houses and Ottoman Imperial Relics section for have an opportunity to see ottoman treasures. Overnight at Istanbul Hotel.",
        ],
      ...
      {
        title: "Day 4",
        subTitle: "FULL DAY KUSADASI EPHESUS TOUR (B/-/D)",
        text: [
          "After breakfast drive to Pamukkale and visit Cotton Castle is an oldest natural structure transformed from calcium rich spring water cascaded over the hillside and reacted with air to form a brilliant white snowy chalk coat. Pamukkale is unique and can be matched by no other site in the world. Continue to our tour with The Ancient City of Hierapolis (Pamukkale) whose ruins are mostly from the Roman era, along with the splendid Pamukkale Travertines, it  was included in the UNESCO World Heritage list as a cultural and natural heritage. Overnight in Pamukkale Hotel.",
        ],
      },
      {
        title: "Day 5",
      ...
      {
        title: "Day 6",
        subTitle: "FULL DAY NORTH CAPPADOCIA TOUR + DEPARTURE TRANSFER (B/L/-)",
        text: [
  ...
  },
  {
    ...
    days: [
      {
        title: "Day 1",
        subTitle: "ARRIVAL TRANSFER > BURSA TOUR DAY (-/L/D)",
        text: [
      ...
      {
        title: "Day 2",
        subTitle: "BURSA > ISTANBUL BOSPHORUS TOUR (B/L/D)",
        text: [
      ...
      {
        title: "Day 3",
        subTitle: "FULL DAY ISTANBUL TOUR + DEPARTURE TRANSFER (B/L/D)",
        text: [
